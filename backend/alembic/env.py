"""Alembic Environment Configuration for DCA Backend.

Configured to use project database settings and model metadata.
"""
...
# Models are defined in compute/job_store.py and quant/data/models.py
